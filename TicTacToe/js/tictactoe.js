...
let activePlayer ='X';
//This array stores an arrey of moves. We use this to determine win conditions.
let selectedSquares=[];
...
//This function parses the selectedSquare array to search for win condtions.
...
function checkWinConditions(){
    ...
    //O 6, 7, 8 condtition. 
    else if(arrayIncludes('6O','7O','8O')) { drawWinLine(50,558,558,508)}
    //O 0, 3, 6 condtition. 
    ...
    //This condition checks for tie. If none of the above conditions register and 9 squares are selected, the code excutes.
...
//This line accesses our html canvas element.
    ...
    let x1 = coordX1,
    //This line incidates where the start of a lines y axis is.
        y1= coordY1,
    //This line incidates where the end of a lines x axis is.
        x2 = coordX2,
    //This line incidates where the end of a lines y axis is.
        y2= coordY2,
    ...
    //This function interacts wiht the canvas
    function animateLineDrawing(){
        ...
        if (x1 <= x2 && y1 <= y2) {
            ...
            //if we've reached the ends point.
    ...
    animateLineDrawing();
    //This line waits 1 second. Then. clears canvas, resets game, and allows click again.
...
function resetGame(){
    ...
    for (let i = 0; i < 9; i++){
        //This varable gets the html element of i.
        let square = document.getElementById(String(i))
        //This removes our elements background image. 
        square.style.backgroundImage = ''
    }
    //This resets our array so it is empty and we can start voer. 
    selectedSquares =[];
}